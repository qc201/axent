...
export const data: ProductInfo[] = [
  ...
  },
  {
    ...
    configuration: {
      ...
      seatlid: ["Adjustable Self-Warming Seat"],
    },
  ...
  },
  {
    ...
    collection: null,
    category: "intelligent",
    name: "U/V Shape Electric Bidet Seat",
    ...
    coverSrc: "/products_img/electric-seat-u-1.png",
    sketchImg: [
  ...
  },
  {
    ...
    features: {
      ...
      weight: "110lbs",
      material: "Vitreous China and Easy Clean Antibacterial Glaz",
      color:
        "White with Space Silver Trim (ALT:Champagne Gold, Rose Gold, White, Mate Black Trims SOLD SEPERATLY)",
    ...
    configuration: {
      ...
      seatlid: ["antibacterial material"],
    },
  ...
  },
  {
    ...
    features: {
      dimensions: "L28.93”*W17.40”*H20.47”",
      material: "Vitreous China",
      color: "White",
      water: "1.0 GPF / 3.8LPF",
    },
    configuration: {
      outlook: ["Antibacterial Easy-to-clean Glaze"],
  ...
  },
  {
    ...
    details:
      "Rich with soft angles and full curves, the Studio Toilet epitomizes a balanced union between modern and classic design. ",
    features: {
      dimensions: "L29 1/2” * W 17” * H 27 3/4”",
      weight: "103lbs",
      material: "Vitreous China",
      color: "White",
      water: "SingleFlush1.28GPF(4.8L)",
    },
    configuration: {
      outlook: [
        "12” Rough In",
  ...
  },
  {
    ...
    imgAlt: "mint-two",
    coverSrc: "/products_img/mint-two-GD.png",
    sketchImg: [
