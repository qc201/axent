...
export default function Basin() {
  ...
  return (
    <div>
      <div className="flex items-center justify-center font-custom sm:bg-fixed bg-basinHeader w-screen sm:bg-cover bg-left sm:bg-center  bg-no-repeat sm:min-h-[1000px] min-h-[600px]">
        <MaskText
