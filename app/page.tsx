  ...
  return (
    <main>
      ...
      <div className="grid sm:grid-cols-3 grid-cols-1  md:gap-1 sm:px-20 md:py-10">
        ...
        <RevealCard imgsrc={"/live_img/basin-header-1024_600.png"} title={"AXENT.ONE PLUS"} imgalt={"AXENT.ONE PLUS"} pagelink={"/bathroom/intelligent/one-plus"} subTitle={"Ingelligent toilet with KIRIN Flush System"} intro={"Inspired by our success and lessons learned in Europe and Asia\’s notoriously condensed urban environments, we\’re introducing North America\’s most intuitive and space-saving toilet – the AXENT.ONE Plus wall-hung intelligent toilet."} />
