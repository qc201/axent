...
export default function InfoCard({
  ...
  return (
    <div className="group text-primary font-custom h-96">
      <Link href={linkTo}>
        <div className="cursor-pointer relative flex flex-col md:my-6 sm:my-2 bg-white shadow-sm md:w-60 sm:w-48 w-40 group-hover:shadow-2xl transition-shadow duration-300 h-full ">
          {unavailable && (
