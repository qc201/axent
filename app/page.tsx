...
export default function Home() {
  ...
  const sliCover: string = "/sli-collection/sli-collection-cover916.jpg";
  const sliCoverSquare: string = "/sli-collection/sli-collection-cover11.jpg";
  const sltCover: string = "/slt-collection/slt-collection-cover916.jpg";
  const sltCoverSquare: string = "/slt-collection/slt-collection-cover11.jpg";
  const slsCover: string = "/sls-collection/sls-803-cover916.jpg";
  const slsCoverSquare: string = "/sls-collection/sls-803-cover11.jpg";
