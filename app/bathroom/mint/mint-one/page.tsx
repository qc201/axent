    ...
    return (
        <div className="pt-20 sm:pt-16 sm:px-[10vw]">
            ...
            <FeatureCard
                ...
                consumption={
                    mintOneData.features.water === null
                        ? ""
                        : mintOneData.features.water
                }
                ...
                <div className="flex flex-col sm:flex-row w-full justify-between sm:items-end sm:text-end">
                    ...
                    <MaskText
                        ...
                        phrases={[
                            ...
                            "Embrace Intelligent Living Instantly", "Efficient Warm Air Dry Motor", "Hygiene and Sterilization Achieved in One Step"
                        ]}
                    />
                </div>
            </div>
