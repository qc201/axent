...
export const newsData: BlogInfo[] = [
  {
    imgsrc:
      "/blog_img/axent-switzerland-to-showcase-innovative-bathroom-solutions-at-kbis-2025-in-las-vegas.jpg",
    ...
    newsPage: `<div className="news-container sm:px-60 px-5 sm:pt-16 pt-20 font-custom text-primary flex flex-col justify-center items-center">
      ...
      <div className="cover-img pt-10 w-full flex flex-col items-center ">
        <img src="/blog_img/axent-switzerland-to-showcase-innovative-bathroom-solutions-at-kbis-2025-in-las-vegas.jpg" alt="cover image" className="w-full h-full object-contain" />
      </div>
      ...
      <div className="news-content pt-10 font-thin text-lg">
        At this year's event, AXENT will unveil its newest intelligent toilets offering state-of-the-art fixture boasts a sleek, tankless design and integrates advanced features such as customizable water temperature and spray position, all controlled via an intuitive side dial reminiscent of a Swiss timepiece.
  
      </div>
  
      <div className="cover-img pt-10 w-full flex flex-col items-center ">
        <img src="/blog_img/axent-switzerland-to-showcase-innovative-bathroom-solutions-at-kbis-2025-in-las-vegas_2.jpg" alt="cover image" className="w-full h-full object-contain" />
      </div>
    </div>`,
  },
  {
  ...
  {
    imgsrc: "/blog_img/palm_springs_modernism_show.png",
    releaseDate: "July, 2023",
    title: "AXENT Switzerland Debuts at 2023 Palm Springs Modernism Show",
    ...
    newsPage: `<div className="news-container sm:px-60 px-5 sm:pt-16 pt-20 font-custom text-primary flex flex-col justify-center items-center">
      ...
      <div className="news-content pt-10 font-thin text-lg">
        ...
        Modernism Show, a prominent event celebrating mid-century modern
        architecture and design. The show, held during Modernism Week, featured
        125 premier national and international exhibitors presenting vintage
        furniture, decor, art, and jewelry reflecting 20th-century design
        movements.
      </div>

      <div className="news-content pt-10 font-thin text-lg">
        AXENT's presence at the show provided an opportunity to engage with
        design enthusiasts and industry professionals, showcasing its products
        in a setting that honors both historical and contemporary design
        innovations.
      </div>
    </div>`,
  },
  {
    imgsrc: "/blog_img/kbis2023.jpg",
    releaseDate: "Feb, 2023",
    title:
      "AXENT Switzerland Showcases Innovative Bathroom Solutions at KBIS 2023",
    location: "LAS VEGAS",
    content: [
      "AXENT Switzerland made a notable appearance at the Kitchen & Bath Industry Show (KBIS) 2023, held in Las Vegas, Nevada. The company showcased its innovative bathroom solutions, highlighting its commitment to design excellence and technological advancement.",
    ],
    pagelink:
      "axent-switzerland-showcases-innovative-bathroom-solutions-at-kbis-2023",
    newsPage: `<div className="news-container sm:px-60 px-5 sm:pt-16 pt-20 font-custom text-primary flex flex-col justify-center items-center">
      ...
      <div className="news-content pt-10 font-thin text-lg">
        ...
        showcased its innovative bathroom solutions, highlighting its commitment
        to design excellence and technological advancement.
      </div>

      <div className="news-content pt-10 font-thin text-lg">
        AXENT's presence at KBIS 2023 reinforced its position as a leader in the
        bathroom fixtures industry, showcasing its latest innovations to a
        diverse audience of industry professionals and design enthusiasts.
      </div>
    </div>`,
  },
  {
    imgsrc: "/blog_img/icff2022.png",
    releaseDate: "May 15, 2022",
    title:
      "AXENT Switzerland Showcases Innovative Bathroom Solutions at ICFF 2022 in New York",
    location: "NEW YORK",
    content: [
      "AXENT Switzerland participated in the International Contemporary Furniture Fair (ICFF) in New York City, showcasing its innovative bathroom solutions to a global audience. The event, held at the Javits Center, is renowned for highlighting contemporary design and serves as a premier platform for international brands.",
    ],
    pagelink:
      "axent-switzerland-showcases-innovative-bathroom-solutions-at-icff-2022-in-new-york",
    newsPage: `<div className="news-container sm:px-60 px-5 sm:pt-16 pt-20 font-custom text-primary flex flex-col justify-center items-center">
